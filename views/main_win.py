...
# nav_frame.columnconfigure(0, minsize=120)
# nav_frame.columnconfigure(1, minsize=10)
# nav_frame.columnconfigure(2, minsize=10)
# nav_frame.columnconfigure(3, minsize=10)
...
# Fundamental Data Readout: Frame placement, config; contents of this frame will be altered/updated dynamically as a result of using the application. see Callback for <Search-button>
...
# Technical Data Readout: Frame placement, config; contents of this frame will be altered/updated dynamically as a result of using the application. see Callback for <Search-button>
